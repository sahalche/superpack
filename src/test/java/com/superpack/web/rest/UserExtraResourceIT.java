...
public class UserExtraResourceIT {
    ...
    public void createUserExtra() throws Exception {
        ...
        assertThat(testUserExtra.getLatitude()).isEqualTo(DEFAULT_LATITUDE);
        assertThat(testUserExtra.getLongitude()).isEqualTo(DEFAULT_LONGITUDE);
    }
    ...
    public void updateUserExtra() throws Exception {
        ...
        assertThat(testUserExtra.getLatitude()).isEqualTo(UPDATED_LATITUDE);
        assertThat(testUserExtra.getLongitude()).isEqualTo(UPDATED_LONGITUDE);
    }
